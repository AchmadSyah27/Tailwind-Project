export default function Header() {
	return (
		<section
			id="jumbotron"
			className="bg-[linear-gradient(rgba(45,34,40,0.9),rgba(45,34,40,0.9)),url('/images/cta-background.jpg')] bg-center bg-cover h-[80vh] flex items-center justify-start text-left p-8 text-primary"
